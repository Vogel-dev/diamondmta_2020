...
local rzeczy = {
	...
	{"Buraki", "", 2, 20, 1},
	{"Kanapka z kurczakiem", "", 5, 15, 2},
	{"Wódka 'Rogówka'", "", 10, 25, 3},
	{"Cygaretka", "", 1, 5, 7},
	{"Kiepowa", "", 4, 5, 6},
}
...
function gui()
	...
	dxDrawImage(688/scale, 294/scale, 547/scale, 491/scale, ":dmta_base_eats2/gfx/bg.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
  ...
  if btn == "left" and state == "down" then
  	for i,v in ipairs(rzeczy) do
  		...
  		if isMouseIn(826*px, 294*py+dodatekY, 91*px, 36*py) and okno == true then
			...
			triggerServerEvent("daj:fastfoody2", localPlayer, v[1])
			triggerServerEvent("zabierz:hajs-food2", localPlayer, v[3])
  		end
  	end
