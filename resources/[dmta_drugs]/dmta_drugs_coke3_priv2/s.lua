...
addEvent("coke3_priv2:animacja", true)
addEventHandler("coke3_priv2:animacja", getRootElement(), function() 
setPedAnimation ( source, 'GANGS', 'prtial_gngtlkG', -1, false, false )
end)

addEvent("coke3_priv2:zanimacja", true) 
addEventHandler("coke3_priv2:zanimacja", getRootElement(), function() 
	local exp = 1
...
addEvent("coke3_priv2:start", true)
addEventHandler("coke3_priv2:start", getRootElement(),
function()
end)

addEvent("daj:coke3_priv2", true)
addEventHandler("daj:coke3_priv2", root, function()
